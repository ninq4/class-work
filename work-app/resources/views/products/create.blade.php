    ...
    <div class="container">
        <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" name="text" id="exampleInputEmail1" aria-describedby="emailHelp">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="brand" id="exampleInputEmail1" aria-describedby="emailHelp">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="guarantee" id="exampleInputEmail1" aria-describedby="emailHelp">
